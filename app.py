...
def log_agent_draft(db, status="Incomplete", step_logs=None, confidence=None, diagnosis=None):
    if db is None:
        return None
    ...
    draft_doc = {
        ...
        "human_in_the_loop": "Pending UI Feedback"
    }
    try:
...
def analyze_scan(input_img):
    global db_client, db_status
    if input_img is None:
        return None, None, "⚠️ Please upload a scan slice first.", "N/A", "N/A", "0.0%", "⚠️ Inference aborted: No input image.", db_status
    ...
    try:
        ...
        return input_img, input_img, f"❌ Preprocessing Error: {e}", "N/A", "N/A", "0.0%", "❌ Processing Failed.", db_status
    ...
    try:
        ...
        return input_img, processed_img, f"❌ Classification Error: {e}", "N/A", "N/A", "0.0%", "❌ Processing Failed.", db_status
...
"""
        ...
        return input_img, processed_img, rl_logs, generalist_pred, label, f"{confidence*100:.1f}%", rag_report, db_status
    ...
    # Extract Level 1 and Level 2 names
    level_1_category = generalist_pred
        
    return input_img, processed_img, rl_logs, level_1_category, label, f"{confidence*100:.1f}%", rag_report, db_status
...
# ==============================================================================
# 10. GRADIO INTERFACE LAYOUT & CUSTOM THEME
# ==============================================================================
...
with gr.Blocks(**blocks_kwargs) as demo:
    ...
    with gr.Row():
        with gr.Column(scale=1):
            ...
            gr.Markdown("### 📥 Patient Scan Upload")
            input_image = gr.Image(
                type="numpy",
                label="Upload Scan Slice (JPEG/PNG)"
            )
